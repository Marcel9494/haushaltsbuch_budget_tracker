...
class MonthPickerBar extends StatefulWidget {
  final DateTime initialDate;
  final ValueChanged<DateTime> onDateChanged;
  final ValueChanged<bool> onPeriodOfTimeChanged;
  ...
  @override
  State<MonthPickerBar> createState() => _MonthPickerBarState();
}

class _MonthPickerBarState extends State<MonthPickerBar> {
  ...
  @override
  void didUpdateWidget(covariant MonthPickerBar oldWidget) {
  ...
  void _onMonthSelected(int index, DateTime currentDate) {
    setState(() {
      _currentIndex = index;
      _selectedDate = _getDateFromIndex(_currentIndex);
    });
          ...
          Expanded(
            child: PageView.builder(
              ...
              itemBuilder: (context, index) {
                final currentDate = _getDateFromIndex(index);
              ...
              child: TextButton(
                onPressed: () {
                  setState(() {
                    ...
                    widget.onPeriodOfTimeChanged(_isYearView);
                  });
                },
