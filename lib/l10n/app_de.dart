const Map<String, String> de = {
  ...
  'delete_booking_confirmation': 'Möchtest du die Buchung wirklich löschen?',
  ...
  'would_you_like_the_category': 'Möchtest du die Kategorie',
  'would_you_like_the_account': 'Möchtest du das Konto',
  'really_delete': 'wirklich löschen',
  'account_name': 'Kontoname',
  'select_account': 'Konto auswählen',
  'debit_account': 'Abbuchungskonto',
  'select_debit_account': 'Abbuchungskonto',
  'target_account': 'Zielkonto',
  'select_target_account': 'Zielkonto',
  ...
  'legal': 'Rechtliches',
  'short_privacy_policy': 'Datenschutz',
  ...
  'no_bookings_for_budget': 'Noch keine Buchungen für dieses Budget vorhanden.',
  'update_budget': 'Budget bearbeiten',
  'delete_budget': 'Budget löschen',
  'in_budget': 'im Budget',
  'enter_monthly_budget': 'Monatsbudget eingeben',
  'minimum': 'Minimum',
  ...
  'delete_goal_confirmation': 'Möchtest du das Ziel wirklich löschen?',
  ...
  'future_budgets': 'Ab diesem Budget',
  'all_budgets': 'Alle Budgets',
  'update_single_budget_description': 'Die Änderungen gelten nur für dieses Budget',
  'update_future_budgets_description': 'Die Änderungen gelten für dieses und alle zukünftigen Budgets dieser Kategorie.',
  'update_all_budgets_description': 'Die Änderungen gelten für alle Budgets dieser Kategorie.',
  'delete_single_budget_description': 'Dieses Budget wird gelöscht',
  'delete_future_budgets_description': 'Dieses und alle zukünftigen Budgets dieser Kategorie werden gelöscht.',
  'delete_all_budgets_description': 'Alle Budgets dieser Kategorie werden gelöscht.',
  'overall_remaining_budget': 'Restl. Budget',
  'single_booking': 'Einzelne Buchung',
  'future_bookings': 'Ab dieser Buchung',
  ...
  'complete_goal_description': 'Du findest alle deine abgeschlossenen Ziele über das Sidebar Menü unter Abgeschlossene Ziele.',
  ...
  'assets_dialog_title': 'Vermögen',
  'assets_dialog_content':
      'Die Konten von folgenden Kontotypen werden als Vermögenswerte klassifiziert:\n- Konto\n- Kapitalanlage\n- Bargeld\n- Karte\n- Versicherung\n- Sonstiges',
  'debts_dialog_title': 'Schulden',
  ...
  'app_owner': 'Marcel Geirhos',
  'app_owner_address': 'Gartenstraße 8, 73550, Waldstetten',
  'app_owner_phone': '+49 176 30721919',
  'app_owner_email': 'Marcel.Geirhos@gmail.com',
  'imprint_date': '10.08.2026',
  'phone': 'Telefon',
  'no_ustidnr': 'Keine USt-IdNr. vorhanden.',
  'responsible_for_content': 'Verantwortlich für den Inhalt',
  'status': 'Stand',
  'only_terms_of_use': 'Nutzungsbedingungen',
  'terms_of_use': 'Nutzungsbedingungen / AGB',
  'view_terms_of_use': 'Nutzungsbedingungen anzeigen',
  'read_terms_of_use': 'Bitte lies die Nutzungsbedingungen und bestätige deine Zustimmung.',
  'accept_terms_of_use': 'Ich akzeptiere die Nutzungsbedingungen.',
  ...
  'number_of_expense_bookings': 'Ausgaben (Anz.)',
  'number_of_transfer_bookings': 'Übertrag (Anz.)',
  'expenses_and_revenue_by_categories': 'Ausgaben und Einnahmen nach Kategorien',
  'your_key_financial_metrics': 'Deine wichtigsten Finanzkennzahlen',
  ...
  // Error Messages
  'empty_email_error': 'Bitte gib eine E-Mail Adresse ein.',
  'invalid_email_error': 'Bitte gib eine gültige E-Mail Adresse ein.',
  'email_validation_error': 'Die E-Mail Adresse enthält ungültige Zeichen. Bitte verwende nur Buchstaben, Zahlen und die Zeichen . _ - @.',
  ...
  'empty_password_error': 'Bitte gib ein Passwort ein.',
  ...
  'empty_amount_error': 'Bitte gib einen Betrag ein.',
  'zero_amount_error': 'Der Betrag darf nicht 0 sein.',
  'empty_goal_amount_error': 'Bitte gib einen Zielbetrag ein.',
  'empty_title_error': 'Bitte gib einen Titel ein.',
  'empty_account_name_error': 'Bitte gib einen Kontoname ein.',
  'empty_goal_name_error': 'Bitte gib einen Zielnamen ein.',
  'empty_category_error': 'Bitte wähle eine Kategorie aus.',
  'empty_category_name_error': 'Bitte gib einen Kategorienamen ein.',
  ...
  'update_account_error': 'Datenbankfehler beim Bearbeiten des Kontos. Bitte versuche es später erneut.',
  'delete_account_error': 'Datenbankfehler beim Löschen des Kontos. Bitte versuche es später erneut.',
  ...
  'load_accounts_error': 'Datenbankfehler beim Laden der Konten. Bitte versuche es später erneut.',
  'create_category_error': 'Datenbankfehler beim Erstellen der Kategorie. Bitte versuche es später erneut.',
  'update_category_error': 'Datenbankfehler beim Bearbeiten der Kategorie. Bitte versuche es später erneut.',
  'delete_category_error': 'Datenbankfehler beim Löschen der Kategorie. Bitte versuche es später erneut.',
  ...
  'create_dashboard_elements_error': 'Datenbankfehler beim Erstellen der Dashboard Elemente. Bitte versuche es später erneut.',
  'load_dashboard_elements_error': 'Datenbankfehler beim Laden der Dashboard Elemente. Bitte versuche es später erneut.',
  'update_users_dashboard_elements_error': 'Datenbankfehler beim Aktualisieren der Dashboard Elemente. Bitte versuche es später erneut.',
  'authentication_error': 'Authentifizierungsfehler bitte versuche es später erneut.',
  'upgrade_account_error': 'Authentifizierungsfehler beim Upgraden des Kontos. Bitte versuche es später erneut.',
